...
def main():
    ...
    fig, axes = plt.subplots(
        *(nr, nc), figsize=(12.4, 5), sharey=True, constrained_layout=True,
    ...
    output_path = os.path.join(BUILD_DIR, f"estimation_circ.svg")
    fig.savefig(output_path, dpi=600)
    output_path = os.path.join(BUILD_DIR, "estimation_circ.pdf")
