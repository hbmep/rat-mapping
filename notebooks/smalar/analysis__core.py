...
def threshold_analysis_lat(model_dir, correction=False, fig=None, dump=False):
    ...
    a = np.mean(posterior[site.a], axis=0, keepdims=True)
    ...
    (
        fig, diff_positions, diff_mean, diff_err, colors, negate, *_
...
def threshold_analysis_size(model_dir, correction=False, fig=None, dump=False):
    ...
    fig, diff_positions, diff_mean, diff_err, colors, negate, *_, = make_compare3p_bar(
        diff, degrees, correction=correction, fig=fig, negate=False
    )
    fig, axes = fig
...
def figure_size(model_dirs, correction=False):
    ...
    ax.axvline(x=0, label=sizes[0][1][1:], color="k", linestyle="--")
    u, v = zip(*positions)
    param_inv = dict(zip(v, range(len(v))))
...
def main_lat():
    ...
    model_dirs = [
        "/home/vishu/reports/rat-mapping/smalar/hb/4000w_4000s_4c_4t_15d_95a_tm/lat-small-ground/hb_mvn_rl_masked",
        "/home/vishu/reports/rat-mapping/smalar/hb/4000w_4000s_4c_4t_15d_95a_tm/lat-small-ground/robust_hb_mvn_rl_masked",
        "/home/vishu/reports/rat-mapping/smalar/hb/4000w_4000s_4c_4t_15d_95a_tm/lat-big-ground/hb_mvn_rl_masked",
        "/home/vishu/reports/rat-mapping/smalar/hb/4000w_4000s_4c_4t_15d_95a_tm/lat-big-ground/robust_hb_mvn_rl_masked",
    ]
    ...
    #     ),
    #     (
    #         "/home/vishu/reports/hbmep/notebooks/rat/loghb/smalar/4000w_4000s_4c_4t_15d_95a_tm/lat-small-ground/robust_hb_mvn_rl_masked",
    #         "/home/vishu/reports/hbmep/notebooks/rat/loghb/smalar/4000w_4000s_4c_4t_15d_95a_tm/lat-small-ground/robust_lat_est_mvn_block_reference_rl_masked",
    #     ),
    #     (
    ...
    #     ),
    #     (
    #         "/home/vishu/reports/hbmep/notebooks/rat/loghb/smalar/4000w_4000s_4c_4t_15d_95a_tm/lat-big-ground/robust_hb_mvn_rl_masked",
    #         "/home/vishu/reports/hbmep/notebooks/rat/loghb/smalar/4000w_4000s_4c_4t_15d_95a_tm/lat-big-ground/robust_lat_est_mvn_block_reference_rl_masked",
    #     ),
    # ]
...
def main_size():
    ...
    # Threshold size
    model_dirs = [
        "/home/vishu/reports/rat-mapping/smalar/hb/4000w_4000s_4c_4t_15d_95a_tm/size-ground/hb_mvn_rl_masked",
        "/home/vishu/reports/rat-mapping/smalar/hb/4000w_4000s_4c_4t_15d_95a_tm/size-ground/robust_hb_mvn_rl_masked",
    ]
    ...
    #     ),
    #     (
    #         "/home/vishu/reports/hbmep/notebooks/rat/loghb/smalar/4000w_4000s_4c_4t_15d_95a_tm/size-ground/robust_hb_mvn_rl_masked",
    #         "/home/vishu/reports/hbmep/notebooks/rat/loghb/smalar/4000w_4000s_4c_4t_15d_95a_tm/size-ground/robust_size_est_mvn_block_reference_rl_masked"
    #     ),
    # ]
