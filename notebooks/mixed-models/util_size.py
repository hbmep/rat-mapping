...
def plot_model(
    ...
    **kws,
    ...
    body_print_ci("# size position", temp_labels, temp_beta, temp_se, decimals=1)
    ...
    body_print_ci("# size distance", distance, mu_beta, se_beta, decimals=1)
    ...
    body_print_ci("# size is_large", ["is_large"], [mu_beta], [se_beta], decimals=1)
